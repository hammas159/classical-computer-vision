# 55 · Hand gesture recognition — classical computer vision
...
uses for background subtraction and project 53 for defects.
...
26 tests, run with `pytest projects/55_hand_gesture/tests -q`. They pin the
