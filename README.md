...
| [03](projects/03_low_light_enhancement/) | Low-light enhancement | Retinex (SSR/MSR/MSRCR), LIME, gamma, HE, CLAHE | *(unverified)* the inverse-gamma oracle ceiling is finite — quantisation destroys tone levels before any method runs | 🟡 |
